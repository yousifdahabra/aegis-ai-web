...
import { cilUser, cilEnvelopeClosed, cilPhone, cilExternalLink, cilInfo } from "@coreui/icons";
...
export default {
  ...
  setup() {
    const icons = { cilUser, cilEnvelopeClosed, cilPhone, cilExternalLink, cilInfo };
    const name = ref("");
    const email = ref("");
